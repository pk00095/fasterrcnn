...
# source: fasterrcnn/protos/optimizer.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='fasterrcnn/protos/optimizer.proto',
  package='fasterrcnn.protos',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n!fasterrcnn/protos/optimizer.proto\x12\x11\x66\x61sterrcnn.protos\"\xa3\x02\n\tOptimizer\x12\x41\n\x12rms_prop_optimizer\x18\x01 \x01(\x0b\x32#.fasterrcnn.protos.RMSPropOptimizerH\x00\x12\x42\n\x12momentum_optimizer\x18\x02 \x01(\x0b\x32$.fasterrcnn.protos.MomentumOptimizerH\x00\x12:\n\x0e\x61\x64\x61m_optimizer\x18\x03 \x01(\x0b\x32 .fasterrcnn.protos.AdamOptimizerH\x00\x12 \n\x12use_moving_average\x18\x04 \x01(\x08:\x04true\x12$\n\x14moving_average_decay\x18\x05 \x01(\x02:\x06\x30.9999B\x0b\n\toptimizer\"\x99\x01\n\x10RMSPropOptimizer\x12\x36\n\rlearning_rate\x18\x01 \x01(\x0b\x32\x1f.fasterrcnn.protos.LearningRate\x12%\n\x18momentum_optimizer_value\x18\x02 \x01(\x02:\x03\x30.9\x12\x12\n\x05\x64\x65\x63\x61y\x18\x03 \x01(\x02:\x03\x30.9\x12\x12\n\x07\x65psilon\x18\x04 \x01(\x02:\x01\x31\"r\n\x11MomentumOptimizer\x12\x36\n\rlearning_rate\x18\x01 \x01(\x0b\x32\x1f.fasterrcnn.protos.LearningRate\x12%\n\x18momentum_optimizer_value\x18\x02 \x01(\x02:\x03\x30.9\"_\n\rAdamOptimizer\x12\x36\n\rlearning_rate\x18\x01 \x01(\x0b\x32\x1f.fasterrcnn.protos.LearningRate\x12\x16\n\x07\x65psilon\x18\x02 \x01(\x02:\x05\x31\x65-08\"\xe8\x02\n\x0cLearningRate\x12I\n\x16\x63onstant_learning_rate\x18\x01 \x01(\x0b\x32\'.fasterrcnn.protos.ConstantLearningRateH\x00\x12Z\n\x1f\x65xponential_decay_learning_rate\x18\x02 \x01(\x0b\x32/.fasterrcnn.protos.ExponentialDecayLearningRateH\x00\x12N\n\x19manual_step_learning_rate\x18\x03 \x01(\x0b\x32).fasterrcnn.protos.ManualStepLearningRateH\x00\x12P\n\x1a\x63osine_decay_learning_rate\x18\x04 \x01(\x0b\x32*.fasterrcnn.protos.CosineDecayLearningRateH\x00\x42\x0f\n\rlearning_rate\"4\n\x14\x43onstantLearningRate\x12\x1c\n\rlearning_rate\x18\x01 \x01(\x02:\x05\x30.002\"\xef\x01\n\x1c\x45xponentialDecayLearningRate\x12$\n\x15initial_learning_rate\x18\x01 \x01(\x02:\x05\x30.002\x12\x1c\n\x0b\x64\x65\x63\x61y_steps\x18\x02 \x01(\r:\x07\x34\x30\x30\x30\x30\x30\x30\x12\x1a\n\x0c\x64\x65\x63\x61y_factor\x18\x03 \x01(\x02:\x04\x30.95\x12\x17\n\tstaircase\x18\x04 \x01(\x08:\x04true\x12\x1f\n\x14\x62urnin_learning_rate\x18\x05 \x01(\x02:\x01\x30\x12\x17\n\x0c\x62urnin_steps\x18\x06 \x01(\r:\x01\x30\x12\x1c\n\x11min_learning_rate\x18\x07 \x01(\x02:\x01\x30\"\xeb\x01\n\x16ManualStepLearningRate\x12$\n\x15initial_learning_rate\x18\x01 \x01(\x02:\x05\x30.002\x12P\n\x08schedule\x18\x02 \x03(\x0b\x32>.fasterrcnn.protos.ManualStepLearningRate.LearningRateSchedule\x12\x15\n\x06warmup\x18\x03 \x01(\x08:\x05\x66\x61lse\x1a\x42\n\x14LearningRateSchedule\x12\x0c\n\x04step\x18\x01 \x01(\r\x12\x1c\n\rlearning_rate\x18\x02 \x01(\x02:\x05\x30.002\"\xbe\x01\n\x17\x43osineDecayLearningRate\x12!\n\x12learning_rate_base\x18\x01 \x01(\x02:\x05\x30.002\x12\x1c\n\x0btotal_steps\x18\x02 \x01(\r:\x07\x34\x30\x30\x30\x30\x30\x30\x12$\n\x14warmup_learning_rate\x18\x03 \x01(\x02:\x06\x30.0002\x12\x1b\n\x0cwarmup_steps\x18\x04 \x01(\r:\x05\x31\x30\x30\x30\x30\x12\x1f\n\x14hold_base_rate_steps\x18\x05 \x01(\r:\x01\x30')
)
...
_OPTIMIZER = _descriptor.Descriptor(
  name='Optimizer',
  full_name='fasterrcnn.protos.Optimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rms_prop_optimizer', full_name='fasterrcnn.protos.Optimizer.rms_prop_optimizer', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='momentum_optimizer', full_name='fasterrcnn.protos.Optimizer.momentum_optimizer', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='adam_optimizer', full_name='fasterrcnn.protos.Optimizer.adam_optimizer', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_moving_average', full_name='fasterrcnn.protos.Optimizer.use_moving_average', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='moving_average_decay', full_name='fasterrcnn.protos.Optimizer.moving_average_decay', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='optimizer', full_name='fasterrcnn.protos.Optimizer.optimizer',
...
_RMSPROPOPTIMIZER = _descriptor.Descriptor(
  ...
  full_name='fasterrcnn.protos.RMSPropOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='fasterrcnn.protos.RMSPropOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='momentum_optimizer_value', full_name='fasterrcnn.protos.RMSPropOptimizer.momentum_optimizer_value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='decay', full_name='fasterrcnn.protos.RMSPropOptimizer.decay', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='epsilon', full_name='fasterrcnn.protos.RMSPropOptimizer.epsilon', index=3,
...
_MOMENTUMOPTIMIZER = _descriptor.Descriptor(
  ...
  full_name='fasterrcnn.protos.MomentumOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='fasterrcnn.protos.MomentumOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='momentum_optimizer_value', full_name='fasterrcnn.protos.MomentumOptimizer.momentum_optimizer_value', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.9),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADAMOPTIMIZER = _descriptor.Descriptor(
  name='AdamOptimizer',
  full_name='fasterrcnn.protos.AdamOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='fasterrcnn.protos.AdamOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='epsilon', full_name='fasterrcnn.protos.AdamOptimizer.epsilon', index=1,
      number=2, type=2, cpp_type=6, label=1,
...
_LEARNINGRATE = _descriptor.Descriptor(
  name='LearningRate',
  full_name='fasterrcnn.protos.LearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='constant_learning_rate', full_name='fasterrcnn.protos.LearningRate.constant_learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exponential_decay_learning_rate', full_name='fasterrcnn.protos.LearningRate.exponential_decay_learning_rate', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='manual_step_learning_rate', full_name='fasterrcnn.protos.LearningRate.manual_step_learning_rate', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cosine_decay_learning_rate', full_name='fasterrcnn.protos.LearningRate.cosine_decay_learning_rate', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='learning_rate', full_name='fasterrcnn.protos.LearningRate.learning_rate',
      index=0, containing_type=None, fields=[]),
  ],
...
_CONSTANTLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='fasterrcnn.protos.ConstantLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='fasterrcnn.protos.ConstantLearningRate.learning_rate', index=0,
...
_EXPONENTIALDECAYLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='fasterrcnn.protos.ExponentialDecayLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='fasterrcnn.protos.ExponentialDecayLearningRate.initial_learning_rate', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.002),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='decay_steps', full_name='fasterrcnn.protos.ExponentialDecayLearningRate.decay_steps', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='decay_factor', full_name='fasterrcnn.protos.ExponentialDecayLearningRate.decay_factor', index=2,
      number=3, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='staircase', full_name='fasterrcnn.protos.ExponentialDecayLearningRate.staircase', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='burnin_learning_rate', full_name='fasterrcnn.protos.ExponentialDecayLearningRate.burnin_learning_rate', index=4,
      number=5, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='burnin_steps', full_name='fasterrcnn.protos.ExponentialDecayLearningRate.burnin_steps', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_learning_rate', full_name='fasterrcnn.protos.ExponentialDecayLearningRate.min_learning_rate', index=6,
...
_MANUALSTEPLEARNINGRATE_LEARNINGRATESCHEDULE = _descriptor.Descriptor(
  ...
  full_name='fasterrcnn.protos.ManualStepLearningRate.LearningRateSchedule',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='step', full_name='fasterrcnn.protos.ManualStepLearningRate.LearningRateSchedule.step', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='fasterrcnn.protos.ManualStepLearningRate.LearningRateSchedule.learning_rate', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.002),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANUALSTEPLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='fasterrcnn.protos.ManualStepLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='fasterrcnn.protos.ManualStepLearningRate.initial_learning_rate', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.002),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='schedule', full_name='fasterrcnn.protos.ManualStepLearningRate.schedule', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='warmup', full_name='fasterrcnn.protos.ManualStepLearningRate.warmup', index=2,
...
_COSINEDECAYLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='fasterrcnn.protos.CosineDecayLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate_base', full_name='fasterrcnn.protos.CosineDecayLearningRate.learning_rate_base', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.002),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_steps', full_name='fasterrcnn.protos.CosineDecayLearningRate.total_steps', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=4000000,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='warmup_learning_rate', full_name='fasterrcnn.protos.CosineDecayLearningRate.warmup_learning_rate', index=2,
      number=3, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='warmup_steps', full_name='fasterrcnn.protos.CosineDecayLearningRate.warmup_steps', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hold_base_rate_steps', full_name='fasterrcnn.protos.CosineDecayLearningRate.hold_base_rate_steps', index=4,
...
Optimizer = _reflection.GeneratedProtocolMessageType('Optimizer', (_message.Message,), dict(
  ...
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.Optimizer)
  ))
...
RMSPropOptimizer = _reflection.GeneratedProtocolMessageType('RMSPropOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.RMSPropOptimizer)
  ))
...
MomentumOptimizer = _reflection.GeneratedProtocolMessageType('MomentumOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.MomentumOptimizer)
  ))
...
AdamOptimizer = _reflection.GeneratedProtocolMessageType('AdamOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.AdamOptimizer)
  ))
...
LearningRate = _reflection.GeneratedProtocolMessageType('LearningRate', (_message.Message,), dict(
  ...
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.LearningRate)
  ))
...
ConstantLearningRate = _reflection.GeneratedProtocolMessageType('ConstantLearningRate', (_message.Message,), dict(
  ...
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.ConstantLearningRate)
  ))
...
ExponentialDecayLearningRate = _reflection.GeneratedProtocolMessageType('ExponentialDecayLearningRate', (_message.Message,), dict(
  ...
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.ExponentialDecayLearningRate)
  ))
...
ManualStepLearningRate = _reflection.GeneratedProtocolMessageType('ManualStepLearningRate', (_message.Message,), dict(
  ...
  LearningRateSchedule = _reflection.GeneratedProtocolMessageType('LearningRateSchedule', (_message.Message,), dict(
    ...
    __module__ = 'fasterrcnn.protos.optimizer_pb2'
    # @@protoc_insertion_point(class_scope:fasterrcnn.protos.ManualStepLearningRate.LearningRateSchedule)
    ))
  ,
  DESCRIPTOR = _MANUALSTEPLEARNINGRATE,
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.ManualStepLearningRate)
  ))
...
CosineDecayLearningRate = _reflection.GeneratedProtocolMessageType('CosineDecayLearningRate', (_message.Message,), dict(
  ...
  __module__ = 'fasterrcnn.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:fasterrcnn.protos.CosineDecayLearningRate)
  ))
