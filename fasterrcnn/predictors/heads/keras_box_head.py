...
class ConvolutionalBoxHead(tf.keras.layers.Layer):
...
class MaskRCNNBoxHead(tf.keras.layers.Layer):
  """Box prediction head.
  ...
  def __init__(self,
    ...
    self._box_encoder_layers.append(
        tf.keras.layers.BatchNormalization(name='BoxEncodingPredictor_batchnorm'))
