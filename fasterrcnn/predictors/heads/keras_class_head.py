...
class ConvolutionalClassHead(tf.keras.layers.Layer):
...
class MaskRCNNClassHead(tf.keras.layers.Layer):
  ...
  def __init__(self,
    ...
    self._class_predictor_layers.append(
        tf.keras.layers.BatchNormalization(name='ClassPredictor_batchnorm'))
