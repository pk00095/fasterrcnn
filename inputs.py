...
from fasterrcnn.builders import preprocessor_builder
from fasterrcnn.core import box_list
from fasterrcnn.core import box_list_ops
# from fasterrcnn.core import densepose_ops
# from fasterrcnn.core import keypoint_ops
from fasterrcnn.core import preprocessor
from fasterrcnn.core import standard_fields as fields
from fasterrcnn.data_decoders import tf_example_decoder
from fasterrcnn.protos import eval_pb2
from fasterrcnn.protos import image_resizer_pb2
from fasterrcnn.protos import input_reader_pb2
from fasterrcnn.protos import model_pb2
from fasterrcnn.protos import train_pb2
from fasterrcnn.utils import config_util
from fasterrcnn.utils import ops as util_ops
...
def train_input(train_config, train_input_config,
                model_config, num_classes, batch_size, min_dim, max_dim):
